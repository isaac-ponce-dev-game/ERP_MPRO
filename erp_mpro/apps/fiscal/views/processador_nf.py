...
class ProcessadorNotaFiscal(object):
    ...
    def montar_nota(self, nota_obj, versao='3.10'):
        ...
        if nota_obj.emit_saida:
            ...
            nfe.infNFe.emit.xFant.valor = nota_obj.emit_saida.pessoa_juridica_info.nome_fantasia
            nfe.infNFe.emit.IE.valor = nota_obj.emit_saida.pessoa_juridica_info.inscricao_estadual
            nfe.infNFe.emit.IEST.valor = nota_obj.emit_saida.iest

            if nota_obj.emit_saida.pessoa_juridica_info.sit_fiscal == 'SN':
                nfe.infNFe.emit.CRT.valor = '1'
            elif nota_obj.emit_saida.pessoa_juridica_info.sit_fiscal == 'SE':
                nfe.infNFe.emit.CRT.valor = '2'
            elif nota_obj.emit_saida.pessoa_juridica_info.sit_fiscal in ('LR', 'LP'):
        ...
        if nota_obj.dest_saida:
            if nota_obj.dest_saida.id_estrangeiro:
                ...
                nfe.infNFe.dest.ISUF.valor = nota_obj.dest_saida.pessoa_juridica_info.suframa
        ...
        if nota_obj.venda.transportadora:
            if nota_obj.venda.transportadora.tipo_pessoa == 'PJ':
                ...
                nfe.infNFe.transp.transporta.IE.valor = nota_obj.venda.transportadora.pessoa_juridica_info.inscricao_estadual
