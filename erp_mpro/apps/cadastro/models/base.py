...
class Pessoa(models.Model):
    ...
    def cpf_cnpj_apenas_digitos(self):
        if self.tipo_pessoa == 'PF':
            if self.pessoa_fisica_info.cpf:
                return re.sub('[./-]', '', self.pessoa_fisica_info.cpf)

        elif self.tipo_pessoa == 'PJ':
            if self.pessoa_juridica_info.cnpj:
                return re.sub('[./-]', '', self.pessoa_juridica_info.cnpj)
    ...
    def inscricao_estadual(self):
        if self.tipo_pessoa == 'PF':
            ...
            if self.pessoa_juridica_info.inscricao_estadual:
                return re.sub('[./-]', '', self.pessoa_juridica_info.inscricao_estadual)
        else:
            return ''
...
class PessoaFisica(models.Model):
    pessoa_id = models.OneToOneField(
        Pessoa, on_delete=models.CASCADE, primary_key=True, related_name='pessoa_fisica_info')
...
class PessoaJuridica(models.Model):
    pessoa_id = models.OneToOneField(
        Pessoa, on_delete=models.CASCADE, primary_key=True, related_name='pessoa_juridica_info')
